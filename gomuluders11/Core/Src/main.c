...
int main(void)
{
  ...
  MX_TIM2_Init();
  /* USER CODE BEGIN 2 */
  HAL_TIM_Base_Start(&htim2); // Timer başlatılır
  HAL_DAC_Start(&hdac, DAC_CHANNEL_1); // DAC başlatılır
  HAL_DACEx_TriangleWaveGenerate(&hdac, DAC_CHANNEL_1, DAC_TRIANGLEAMPLITUDE_4095);
 // HAL_DACEx_NoiseWaveGenerate(&hdac, DAC1_CHANNEL_1, DAC_LFSRUNMASK_BITS11_0); //4095 için DAC_LFSRUNMASK_BITS11_0
